...
----------
    # OLD (deprecated):
    from grape_recorder.core.spectrogram_generator import SpectrogramGenerator
    gen = SpectrogramGenerator(data_root, channel_name)
    gen.generate_day('20251204')
    
    # NEW (recommended):
    from grape_recorder.core.carrier_spectrogram import CarrierSpectrogramGenerator
